...
function HowItWorks() {
  const steps = [
    ...
    },
    {
      n: '٢',
      title: 'ادفع طلبك',
      body: 'مدى، Apple Pay، STC Pay، فيزا — كل وسائل الدفع الآمنة عبر موياسر',
    },
    {
      n: '٣',
...
function Faq() {
  const items = [
    ...
    },
    {
      ...
      a: 'مدى، Apple Pay، STC Pay، فيزا، ماستركارد — عبر بوّابة موياسر الآمنة. تصلك فاتورة ضريبية في الإيميل خلال يوم.',
    },
    {
