    ...
    <PageShell>
      ...
      <div className="space-y-6 max-w-3xl mx-auto">
        <Step
          ...
          body="ادخل صفحة الطلب، اختر باقتك، واملأ التفاصيل: نوع المناسبة، الأسماء، التاريخ، المكان، وأهمّ عنصر — وصف التصميم الذي تتخيّله بأسلوبك الخاص. كلّما زادت التفاصيل، كانت دعوتك أقرب لذوقك. النموذج يحفظ تلقائيًّا، ويمكنك العودة إليه في أيّ وقت."
        />
        <Step
          n="٢"
          title="ادفع بأمان"
          body="نرسل لك رابط الدفع — مدى، Apple Pay، STC Pay، فيزا. تدفع بأمان، والفاتورة تصلك على الإيميل. ولو غيّرت رأيك قبل أن نبدأ، نُعيد لك مبلغك كاملًا."
        />
        <Step
          n="٣"
        ...
        <Step
          n="٤"
          title="استلم وشاركها"
          body="يصلك رابط الدعوة + بيانات لوحة التحكم على البريد والواتساب. تفتح اللوحة، تشاهد معاينة الدعوة، تطلب تعديلًا إن أردت، ثم تشاركها على واتساب بنقرة واحدة. ضيوفك يفتحونها بمعاينة فاخرة، يؤكّدون حضورهم، وتتابع كل شيء من لوحتك."
        />
      </div>

      <H2>أسئلة شائعة عن سير العمل</H2>
      <div className="space-y-4 max-w-3xl mx-auto">
        <Faq q="هل يمكنني التعديل بعد التسليم؟">
          نعم. المُمَيَّزَة تتضمّن تعديلًا واحدًا مجانيًّا، الفاخِرَة ٣ تعديلات، المَلَكِيَّة غير محدودة. التعديلات الإضافية في الباقتين الأقل متاحة كإضافات بسيطة (١٥٠ ر.س لكل ٥ تعديلات).
        </Faq>
        ...
        <Faq q="هل تعملون أيام الجمعة والسبت؟">
