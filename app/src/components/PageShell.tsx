...
const WHATSAPP_NUMBER = '966550047481';
const WHATSAPP_MESSAGE = 'السلام عليكم، عندي استفسار عن دعوتي';
  ...
  return (
    <a
      ...
      style={{
        ...
        background: '#25D366',
        boxShadow:
          '0 10px 28px rgba(37, 211, 102, 0.45), 0 4px 10px rgba(0, 0, 0, 0.18)',
      }}
    >
      <svg
        width="32"
