...
export const WEDDING_OCCASIONS: Occasion[] = [
  ...
  },
  {
    id: 'milka',
    label: 'حفل ملكة',
    description: 'عقد القران (الملكة) — قبل العرس بأشهر أو معه.',
    category: 'wedding',
    emoji: '📜',
    recommendedTier: 'fakhira',
    defaultVerseId: 'rum-21',
  },
  {
    id: 'aqd-qaran',
    label: 'عقد قِران',
    description: 'مراسم العقد الديني في المسجد أو البيت.',
    category: 'wedding',
    emoji: '🕌',
    recommendedTier: 'mumayyaza',
    defaultVerseId: 'rum-21',
  },
  {
    id: 'henna',
    label: 'ليلة الحنّاء',
    description: 'ليلة الحنّاء النسائية قبل العرس بيوم أو يومين.',
    category: 'wedding',
    emoji: '🌹',
    recommendedTier: 'fakhira',
  },
